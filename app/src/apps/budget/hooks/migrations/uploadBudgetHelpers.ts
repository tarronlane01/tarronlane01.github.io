...
import type { FirestoreData, CategoryMonthBalance } from '@budget/types'
import type { MonthDocument } from '@budget/data/types/month/MonthDocument'
import type { PayeesDocument } from '@budget/data/types/PayeesDocument'
