...
import { useUpdateAccounts, useUpdateAccountGroups, useDeleteAccount, useDeleteAccountGroup } from '@budget/data/mutations/budget'
import { useBudgetData } from './useBudgetData'
import type { FinancialAccount, AccountsMap, AccountGroup, AccountGroupsMap } from '@budget/types'
