...
import type { IncomeTransaction } from '@budget/types'
import { formatCurrency } from '@budget/components/ui'
...
export function IncomeGridRow({ income, accountName, accountGroupName, onEdit, onDelete, isMobile, isEvenRow }: IncomeGridRowProps) {
  ...
  return (
    <div style={{
      ...
      background: rowBg,
      display: 'grid',
      gridTemplateColumns: '5rem 1.5fr 1fr 6rem 1fr 4rem', // Match parent grid columns
    }}>
      {/* Date */}
