...
import type { TransferTransaction, FinancialAccount, AccountGroupsMap, CategoriesMap, CategoryGroup } from '@budget/types'
import { NO_ACCOUNT_ID, NO_ACCOUNT_NAME, NO_CATEGORY_ID, NO_CATEGORY_NAME } from '@budget/data/constants'
import {
  FormWrapper,
  FormField,
  TextInput,
...
import { CategoryAutocomplete, AccountAutocomplete } from '@budget/components/ui'
