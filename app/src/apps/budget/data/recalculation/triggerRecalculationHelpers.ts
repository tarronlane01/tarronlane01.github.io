...
import type { FirestoreData, MonthMap, MonthDocument } from '@budget/types'
...
import { calculatePreviousMonthIncome } from '@budget/data/queries/month/calculatePreviousMonthIncome'
...
export async function updateBudgetBalances(
  ...
  const { writeBudgetData } = await import('@budget/data/mutations/budget/writeBudgetData')
