...
/**
 * Get the minimum allowed month (3 months ago by default)
 */
 ...
 * If there are months earlier than 3 months ago in the map, use the earliest.
 *
...
/**
 * Check if a month is too far in the past (more than 3 months, unless month_map has earlier months)
 *
